...
elseif (ORC_PACKAGE_KIND STREQUAL "vcpkg")
  ...
  get_target_property(SNAPPY_LIB_PATH Snappy::snappy IMPORTED_LOCATION)
  message(STATUS "Snappy library path: ${SNAPPY_LIB_PATH}")
  ...
  add_resolved_library (orc_snappy ${SNAPPY_LIB_PATH} ${SNAPPY_INCLUDE_DIRS})
  list (APPEND ORC_SYSTEM_DEPENDENCIES Snappy)
  list (APPEND ORC_INSTALL_INTERFACE_TARGETS "$<INSTALL_INTERFACE:Snappy::snappy>")
