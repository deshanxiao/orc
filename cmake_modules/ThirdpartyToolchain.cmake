...
elseif (ORC_PACKAGE_KIND STREQUAL "vcpkg")
  ...
  get_target_property(SNAPPY_LINK_LIBS Snappy::snappy INTERFACE_LINK_LIBRARIES)
  message(STATUS "Snappy library path: ${SNAPPY_LINK_LIBS}")
  get_target_property(SNAPPY_INCLUDE_DIRS Snappy::snappy INTERFACE_INCLUDE_DIRECTORIES)
  message(STATUS "Snappy include directories: ${SNAPPY_INCLUDE_DIRS}")
  add_resolved_library (orc_snappy ${SNAPPY_LINK_LIBS} ${SNAPPY_INCLUDE_DIRS})
  list (APPEND ORC_SYSTEM_DEPENDENCIES Snappy)
  list (APPEND ORC_INSTALL_INTERFACE_TARGETS "$<INSTALL_INTERFACE:Snappy::snappy>")
